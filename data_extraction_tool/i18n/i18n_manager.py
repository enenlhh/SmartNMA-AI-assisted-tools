...
Data Extraction Tool Internationalization Language Manager
Multi-language interface supporting Chinese and English switching
"""
...
class LanguageManager:
        ...
        try:
            ...
            if os.path.exists(self.config_file):
                ...
                self.messages = {
                    "en": {
                        "messages": {
                            "system_title": "🎯 SmartEBM Data Extraction System - Interactive Mode",
    ...
    def select_language(self) -> str:
        """交互式语言选择 / Interactive language selection"""
        # 显示双语言选择提示
        print("=" * 60)
...
def get_message(key: str, **kwargs) -> str:
    """便捷函数：获取本地化消息 / Convenience function: get localized message"""
    return get_language_manager().get_message(key, **kwargs)


def select_language() -> str:
    """便捷函数：选择语言 / Convenience function: select language"""
